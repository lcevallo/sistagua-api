class OficinasEmpresa:
    def __init__(self, __id, fk_cliente_empresarial, fk_provincia, fk_canton, fk_parroquia, sector, direccion, telefono_convencional, created_at, updated_at, publish):
        self.__id = __id
